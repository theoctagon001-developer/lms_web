...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- Screen Title -->
        <h1 class="text-2xl sm:text-3xl font-bold text-blue-800 text-center mb-6">Upload Date Sheet</h1>
        ...
        <div class="upload-container animate-fade-in">
            <!-- Exam Type Dropdown -->
            <div class="mt-4">
                <h2 class="text-lg font-semibold text-gray-800 mb-2">Exam Type</h2>
                <select id="exam-type" class="type-select">
            ...
            <div class="mt-4">
                ...
                <div class="file-upload" id="file-upload-area">
                    ...
                    <a href="/DATESHEET.xlsx" class="sample-file-link" download>
    ...
    <script>
        ...
        function setupEventListeners() {
            ...
            // Exam type change
            examTypeSelect.addEventListener('change', updateUploadButtonState);
        ...
        function updateUploadButtonState() {
            ...
            uploadBtn.disabled = !(file && examType);
        }
        ...
        async function handleFileUpload() {
            ...
            if (!examType) {
                showToast('Please select an exam type', 'warning');
                return;
            }
            ...
            try {
                const response = await fetch(`${API_BASE_URL}api/Uploading/uplaod/Date_Sheet`, {
                    method: 'POST',
                    body: formData
                });
                ...
                if (response.ok) {
                    ...
                    showToast(`Date sheet processed successfully (${result.success_count} success, ${result.error_count} errors)`, 'success');
                } else {
        ...
        function displayUploadResults(data) {
            ...
            if (data.Success && data.Success.length > 0) {
                ...
                successCount.textContent = data.success_count || data.Success.length;
            ...
            if (data.Error && data.Error.length > 0) {
                data.Error.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${item.reason || 'Unknown error'}</td>
                        <td>${item.Section || 'N/A'}</td>
                        <td>${item.Course || 'N/A'}</td>
                        <td>${item.Day || 'N/A'}</td>
                    `;
                ...
                errorCount.textContent = data.error_count || data.Error.length;
