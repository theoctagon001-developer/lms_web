            ...
            <div class="container mx-auto max-w-6xl">
                ...
                <div class="card mb-6">
                    <div class="card-header">
                        <h2 class="card-title">
                            <i class="fas fa-users me-2"></i> Teacher Directory
                        </h2>
                        <a href="{{ route('Director.junior') }}" class="btn btn-info">
                            <i class="fas fa-user-graduate"></i>
                            <span class="hidden sm:inline">View Junior Lecturers</span>
                        </a>
                    </div>
                    <div class="card-body">
                        ...
                        <div id="search-status" class="search-status" style="display: none;">
                            ...
                            Found <span id="search-count">0</span> teachers matching your search
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="modal-teacher-name">
                    <i class="fas fa-book mr-2"></i> Teacher Courses
                </h3>
    ...
    renderTeachers();
                ...
                tableBody.innerHTML = `
                    <tr>
                        <td colspan="6" class="empty-state">
                            ...
                            <p class="empty-state-text">No teachers found matching your search criteria.</p>
            ...
            paginatedTeachers.forEach((teacher, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td data-label="Username">
                        <span class="badge badge-primary">${teacher.user.username}</span>
                    </td>
                    <td data-label="Email">
                        <a href="mailto:${teacher.user.email}" class="text-blue-600 hover:underline">${teacher.user.email}</a>
                    </td>
                    <td data-label="CNIC">
                        ${teacher.cnic}
                    </td>
        ...
        async function loadCourses() {
            try {
                ...
                const response = await fetch(`${API_BASE_URL}api/Teachers/your-courses?teacher_id=${currentTeacherId}`);
                const data = await response.json();
        ...
        function renderCourses(coursesData) {
            ...
            if (coursesData.active_courses && coursesData.active_courses.length > 0) {
                activeCoursesContainer.innerHTML = coursesData.active_courses.map(course => `
                    <div class="course-item">
                        <div class="course-name">${course.course_name}</div>
                        <div class="course-details">
                            <div class="course-detail">
                                <i class="fas fa-calendar-alt"></i>
                                <span>Semester: ${course.section_name}</span>
                            </div>
                            <div class="course-detail">
            ...
            if (coursesData.previous_courses && Object.keys(coursesData.previous_courses).length > 0) {
                ...
                for (const semester in coursesData.previous_courses) {
                    ...
                    html += coursesData.previous_courses[semester].map(course => `
                        <div class="course-item">
                            <div class="course-name">${course.course_name}</div>
                            <div class="course-details">
                                <div class="course-detail">
