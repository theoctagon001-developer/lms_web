...
<head>
    ...
    <title>Upload Offered Course with Teacher Allocation</title>
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- Screen Title -->
        <h1 class="text-2xl sm:text-3xl font-bold text-blue-800 text-center mb-6">Upload Offered Course with Teacher Allocation</h1>
        ...
        <div class="upload-container animate-fade-in">
            ...
            <div class="mt-4">
                ...
                <div class="file-upload" id="file-upload-area">
                    ...
                    <a href="/ResultList.xlsx" class="sample-file-link" download>
    ...
    <script>
        ...
        async function handleFileUpload() {
            ...
            `;
            try {
                const response = await fetch(`${API_BASE_URL}api/Uploading/uplaod/SubjectFullResult`, {
                    method: 'POST',
                    body: formData
                });
        ...
        function displayUploadResults(data) {
            ...
            if (data.Success && data.Success.length > 0) {
                ...
                successCount.textContent = data['Added'] || data.Success.length;
