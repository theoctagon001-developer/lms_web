    ...
    <div class="container mx-auto px-4 py-6">
        <div class="flex justify-between items-center mb-4 flex-wrap gap-4">
            ...
            <div class="top-actions">
                <button class="add-btn" onclick="window.location.href='{{ route('hod.juniors.add') }}'">
                    📝 Add Junior Lecturer
                </button>
                <button class="bulk-add-btn" onclick="window.location.href='{{ route('hod.juniors.add_junior_excel') }}'">
                    📁 Bulk Upload
                </button>
            </div>
        </div>
