    ...
    <div class="flex flex-1 overflow-hidden">
        <div class="max-w-6xl mx-auto p-4">
            ...
            <div class="container mx-auto p-4">
                <h2 class="text-xl font-bold text-center mb-4">Full Timetable of Session
                    :{{ session('currentSession') }}</h2>
                                ...
                                <tbody>
                                    @php
                                        ...
                                        foreach ($schedule as $class) {
                                            $teacherData =
                                                $class['teacher'] == 'N/A'
                                                    ? $class['junior_lecturer'] ?? 'N/A'
                                                    : ($class['junior_lecturer'] == 'N/A'
                                                        ? $class['teacher'] ?? 'N/A'
                                                        : $class['teacher'] . ', ' . $class['junior_lecturer']);
                                            $teacherData =
                                                $class['description'] .
                                                ' _( ' .
                                                $teacherData .
