...
<body class="bg-blue-50">
    ...
    <div class="flex flex-1 overflow-hidden">
        <div class="flex-1 overflow-auto">
            <div class="container mx-auto px-4 py-6">
                <!-- Screen Title -->
                <h2 class="text-2xl sm:text-3xl font-bold text-blue-700 text-center mb-4">Upload Course Data</h2>
                ...
                <div class="upload-container animate-fade-in">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="file-upload" id="file-upload-area">
                            ...
                            <a href="/Course.xlsx" class="sample-file-link" download>
    ...
    <script>
        ...
        async function handleFileUpload() {
            ...
            try {
                const response = await fetch(`${API_BASE_URL}api/Uploading/excel-upload/add-or-update-courses`, {
                    method: 'POST',
                    body: formData
                });
                ...
                if (response.ok) {
                    ...
                    showToast('Courses processed successfully', 'success');
                } else {
            ...
            if (data.success && data.success.length > 0) {
                data.success.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${item.Logs || 'No data available'}</td>
                    `;
            ...
            if (data.failed && data.failed.length > 0) {
                data.failed.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${item.reason || item.Record || 'Unknown error'}</td>
                    `;
