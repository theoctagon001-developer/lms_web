...
<head>
    ...
    <title>Upload Junior Course Allocation</title>
...
<body class="bg-blue-50">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-1 overflow-auto">
            <div class="container mx-auto px-4 py-6">
                <!-- Screen Title -->
                <h2 class="text-2xl sm:text-3xl font-bold text-blue-700 text-center mb-4">Upload Junior Course Allocations</h2>

                <!-- Current Session Banner -->
                <div class="w-full bg-blue-600 text-white text-center py-2 text-lg font-semibold shadow-md rounded-t-lg mb-6">
                ...
                <div class="upload-container animate-fade-in">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="file-upload" id="file-upload-area">
                            ...
                            <a href="/junior_allocation.xlsx" class="sample-file-link" download>
                ...
                <div id="results-section" class="mt-8 hidden">
                    <div id="stats-panel" class="bg-white rounded-lg shadow-md p-4 mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                            <div class="bg-blue-50 p-3 rounded-lg">
                                <p class="text-sm text-blue-600 font-medium">Total Records</p>
                                <p id="total-records" class="text-2xl font-bold text-blue-700">0</p>
                            </div>
                            <div class="bg-green-50 p-3 rounded-lg">
                                <p class="text-sm text-green-600 font-medium">Successfully Added</p>
                                <p id="added-count" class="text-2xl font-bold text-green-700">0</p>
                            </div>
                            <div class="bg-red-50 p-3 rounded-lg">
                                <p class="text-sm text-red-600 font-medium">Faulty Records</p>
                                <p id="failed-count" class="text-2xl font-bold text-red-700">0</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        async function handleFileUpload() {
            ...
            try {
                const response = await fetch(`${API_BASE_URL}api/Uploading/excel-upload/assign-juniorlecturer`, {
                    method: 'POST',
                    body: formData
                });
                ...
                if (response.ok) {
                    ...
                    showToast('Junior course allocations uploaded successfully', 'success');
                } else {
        ...
        function displayUploadResults(data) {
            ...
            // Update statistics
            totalRecords.textContent = data["Total Records"] || 0;
            addedCount.textContent = data["Added"] || 0;
            ...
            if (data["Succes"] && data["Succes"].length > 0) {
                ...
                successCount.textContent = data["Succes"].length;
            } else {
            ...
            if (data["Faulty DATA"] && data["Faulty DATA"].length > 0) {
                ...
                errorCount.textContent = data["Faulty DATA"].length;
            } else {
