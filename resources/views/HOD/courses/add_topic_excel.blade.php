...
<head>
    ...
    <title>Upload Course Topics</title>
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-1 overflow-auto">
            <div class="container mx-auto px-4 py-6">
                <!-- Screen Title -->
                <h2 class="text-2xl sm:text-3xl font-bold text-blue-700 text-center mb-4">Upload Course Topics</h2>
                ...
                <div class="upload-container animate-fade-in">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="file-upload" id="file-upload-area">
                            ...
                            <a href="/topic.xlsx" class="sample-file-link" download>
    ...
    <script>
        ...
        function setupEventListeners() {
            ...
            sessionSelect.addEventListener('change', (e) => {
                ...
                populateCourseSelect(sessionId);
                courseSelect.value = '';
        ...
        function populateCourseSelect(sessionId) {
        ...
        function updateUploadButtonState() {
            ...
            uploadBtn.disabled = !(session && course && file);
        }
        ...
        async function handleFileUpload() {
            ...
            if (!sessionId || !courseId || !file) {
                showToast('Please select a session, course, and file', 'warning');
                return;
            }
            ...
            try {
                const response = await fetch(`${API_BASE_URL}api/Uploading/uplaod/Topic`, {
                    method: 'POST',
                    body: formData
                });
        ...
        function displayUploadResults(data) {
            ...
            if (data.Stats && data.Stats.length > 0) {
                ...
                successCount.textContent = data.Stats.length;
            } else {
